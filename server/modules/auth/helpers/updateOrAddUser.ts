import { IUser, DBUser, _getUpdatedUser, getUserOAuthID } from '../../User';
...
export type TUpdateOrAddUserResult = TE.TaskEither<DBError, IUser | DBUser>;
...
interface IHandleUserUpdate {
    ...
    ) => (maybeDBUsr: O.Option<DBUser>) => TUpdateOrAddUserResult;
}
        ...
        O.fold(
            ...
            flow(
                ...
                E.fold(
                    ...
                    (dbUsr) => TE.of<never, DBUser>(dbUsr),
