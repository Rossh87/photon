...
export const _LocalSignupRequest = t.type({
    registeredEmailAddress: EmailAddress,
    passWord: Password,
});

export const LocalSignupRequest = t.exact(_LocalSignupRequest);

export type TLocalSignupRequest = t.TypeOf<typeof LocalSignupRequest>;
